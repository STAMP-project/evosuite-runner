...
public class ProgressFile_ESTest extends ProgressFile_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
          ...
          try { 
            ProgressFile.setProgress("k+I|WU/", 0);
            fail("Expecting exception: SecurityException");
          
          } catch(SecurityException e) {
             //
             // Security manager blocks (\"java.io.FilePermission\" \"k+I|WU\" \"write\")
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn("=;j").when(file0).getAbsolutePath();
      Path path0 = mock(Path.class, new ViolatedAssumptionAnswer());
      doReturn("=;j").when(path0).toString();
      doReturn(fileSystem0).when(path0).getFileSystem();
      doReturn(file0).when(path0).toFile();
      int int0 = ProgressFile.getProgress(path0);
      assertEquals((-1), int0);
  }
  ...
  public void test02()  throws Throwable  {
      // Undeclared exception!
      try { 
        ProgressFile.setProgress((String) null, 3444);
  ...
  public void test06()  throws Throwable  {
      boolean boolean0 = ProgressFile.isValidProgressValue(142);
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      boolean boolean0 = ProgressFile.isValidProgressValue(30);
      assertTrue(boolean0);
  }
  ...
  public void test08()  throws Throwable  {
      Path path0 = mock(Path.class, new ViolatedAssumptionAnswer());
      boolean boolean0 = ProgressFile.setProgress(path0, 142);
      assertFalse(boolean0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ProgressFile.setProgress(path0, 30);
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      int int0 = ProgressFile.getProgress("Invalid progress value: ");
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      boolean boolean0 = ProgressFile.setProgress("DQo\"MMAk_gP={D", (-1540));
      assertFalse(boolean0);
  }
