...
public class ProgressFile_ESTest extends ProgressFile_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
          ...
          try { 
            ProgressFile.setProgress("Error while reading the first line of ", 100);
            fail("Expecting exception: SecurityException");
          
          } catch(SecurityException e) {
             //
             // Security manager blocks (\"java.io.FilePermission\" \"Error while reading the first line of \" \"write\")
  ...
  public void test02()  throws Throwable  {
      // Undeclared exception!
      try { 
        ProgressFile.setProgress((String) null, (-3358));
        fail("Expecting exception: NullPointerException");
  ...
  public void test06()  throws Throwable  {
      boolean boolean0 = ProgressFile.setProgress((Path) null, (-4437));
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      boolean boolean0 = ProgressFile.isValidProgressValue((-1553));
      assertFalse(boolean0);
  }
  ...
  public void test08()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
          ...
          // Undeclared exception!
          try { 
            ProgressFile.setProgress("j9mNZu`:`N;aN", 0);
            fail("Expecting exception: SecurityException");
          
          } catch(SecurityException e) {
             //
             // Security manager blocks (\"java.io.FilePermission\" \"j9mNZu`:`N;aN\" \"write\")
             // java.lang.Thread.getStackTrace(Thread.java:1552)
             // org.evosuite.runtime.sandbox.MSecurityManager.checkPermission(MSecurityManager.java:434)
             // java.lang.SecurityManager.checkWrite(SecurityManager.java:979)
             // sun.nio.fs.UnixChannelFactory.open(UnixChannelFactory.java:247)
  ...
  public void test09()  throws Throwable  {
      boolean boolean0 = ProgressFile.isValidProgressValue(538);
      assertFalse(boolean0);
  }
  ...
  public void test13()  throws Throwable  {
      int int0 = ProgressFile.getProgress("ByteSource.wrap(");
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      boolean boolean0 = ProgressFile.setProgress("", (-6872));
      assertFalse(boolean0);
  }
