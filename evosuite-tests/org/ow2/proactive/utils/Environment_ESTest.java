...
public class Environment_ESTest extends Environment_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      environment_POSIX0.libc = (Object) "Kaxb.@";
      // Undeclared exception!
      try { 
        Environment.setenv("Kaxb.@", "Kaxb.@", false);
  ...
  public void test03()  throws Throwable  {
      int int0 = Environment.setenv("fCu", "fCu", true);
      assertEquals(0, int0);
  }
  ...
  public void test04()  throws Throwable  {
      Environment.POSIX environment_POSIX0 = Environment.getPOSIXinstance();
      environment_POSIX0.libc = (Object) "Ksxbq@";
      // Undeclared exception!
      try { 
        environment_POSIX0.unsetenv("Ksxbq@");
        fail("Expecting exception: ClassCastException");
  ...
  public void test05()  throws Throwable  {
      Environment.POSIX environment_POSIX0 = Environment.getPOSIXinstance();
      int int0 = environment_POSIX0.setenv("!C", "!C", 2);
      assertEquals(0, int0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        environment_POSIX0.setenv("Kaxb.@", "Kaxb.@", 0);
        fail("Expecting exception: ClassCastException");
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals(336, map0.size());
      
      int int0 = Environment.setenv("uo0{", "uo0{", true);
      assertEquals(0, int0);
  }
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        Environment.setenv("09L=1pNd{:}9tu^%(ho", "09L=1pNd{:}9tu^%(ho", true);
  ...
  public void test11()  throws Throwable  {
      Environment.POSIX environment_POSIX0 = Environment.getPOSIXinstance();
      environment_POSIX0.libc = (Object) "yaQ@";
      // Undeclared exception!
      try { 
        Environment.unsetenv("Ka.@");
        fail("Expecting exception: ClassCastException");
  ...
  public void test12()  throws Throwable  {
      Environment.POSIX environment_POSIX0 = Environment.getPOSIXinstance();
      environment_POSIX0.libc = (Object) "Digitl Unix";
  ...
  public void test13()  throws Throwable  {
      int int0 = Environment.unsetenv("Ka.@");
      assertEquals(0, int0);
  }
