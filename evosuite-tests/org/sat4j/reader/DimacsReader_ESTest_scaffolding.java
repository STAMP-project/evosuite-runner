...
public class DimacsReader_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Enumeration", false, DimacsReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.Solver", false, DimacsReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.SubModelIterator", false, DimacsReader_ESTest_scaffolding.class.getClassLoader()));
  }
