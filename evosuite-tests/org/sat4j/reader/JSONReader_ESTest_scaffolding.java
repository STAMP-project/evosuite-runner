...
public class JSONReader_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.reader.JSONReader"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.InputStream", false, JSONReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.Writer", false, JSONReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.ISolver", false, JSONReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.FullClauseSelectorSolver", false, JSONReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.LexicoDecorator", false, JSONReader_ESTest_scaffolding.class.getClassLoader()));
  }
