...
public class InstanceReader_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.InputStream", false, InstanceReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.Writer", false, InstanceReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.DimacsOutputSolver", false, InstanceReader_ESTest_scaffolding.class.getClassLoader()));
  }
