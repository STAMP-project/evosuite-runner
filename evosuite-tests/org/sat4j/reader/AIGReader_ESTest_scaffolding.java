...
public class AIGReader_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.reader.AIGReader"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AIGReader_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.InputStream", false, AIGReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.Writer", false, AIGReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Enumeration", false, AIGReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.core.ASolverFactory", false, AIGReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.constraints.ClausalDataStructureWL", false, AIGReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.ModelIterator", false, AIGReader_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AIGReader_ESTest_scaffolding.class.getClassLoader()); 
