...
public class OptToSatAdapter_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.tools.OptToSatAdapter"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OptToSatAdapter_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sat4j.core.ASolverFactory", false, OptToSatAdapter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.LearningStrategy", false, OptToSatAdapter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.opt.MaxSatDecorator", false, OptToSatAdapter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.opt.MinOneDecorator", false, OptToSatAdapter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.IVec", false, OptToSatAdapter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.SingleSolutionDetector", false, OptToSatAdapter_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OptToSatAdapter_ESTest_scaffolding.class.getClassLoader()); 
