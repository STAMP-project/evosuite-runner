...
public class ClausalCardinalitiesDecorator_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.Writer", false, ClausalCardinalitiesDecorator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.constraints.CardinalityDataStructureYanMin", false, ClausalCardinalitiesDecorator_ESTest_scaffolding.class.getClassLoader()));
