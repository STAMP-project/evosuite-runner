...
public class ClausalCardinalitiesDecorator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.tools.ClausalCardinalitiesDecorator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ClausalCardinalitiesDecorator_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sat4j.core.ASolverFactory", false, ClausalCardinalitiesDecorator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.constraints.ClausalDataStructureWL", false, ClausalCardinalitiesDecorator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.ILits", false, ClausalCardinalitiesDecorator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.ISolver", false, ClausalCardinalitiesDecorator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.IVecInt", false, ClausalCardinalitiesDecorator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.UnitPropagationListener", false, ClausalCardinalitiesDecorator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.FullClauseSelectorSolver", false, ClausalCardinalitiesDecorator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.ManyCore", false, ClausalCardinalitiesDecorator_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ClausalCardinalitiesDecorator_ESTest_scaffolding.class.getClassLoader()); 
