...
public class GroupClauseSelectorSolver_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.tools.GroupClauseSelectorSolver"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GroupClauseSelectorSolver_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.Writer", false, GroupClauseSelectorSolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.core.ASolverFactory", false, GroupClauseSelectorSolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.ILits", false, GroupClauseSelectorSolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.ISolver", false, GroupClauseSelectorSolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.IVecInt", false, GroupClauseSelectorSolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.ManyCore", false, GroupClauseSelectorSolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.ModelIterator", false, GroupClauseSelectorSolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.OptToSatAdapter", false, GroupClauseSelectorSolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.SolutionCounter", false, GroupClauseSelectorSolver_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GroupClauseSelectorSolver_ESTest_scaffolding.class.getClassLoader()); 
