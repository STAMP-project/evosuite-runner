...
public class Policy_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.tools.encoding.Policy"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sat4j.specs.ISolver", false, Policy_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.AbstractMinimalModel", false, Policy_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.SolutionFoundListener", false, Policy_ESTest_scaffolding.class.getClassLoader()));
  }
