...
public class ManyCore_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.tools.ManyCore"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ManyCore_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.Writer", false, ManyCore_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.core.ASolverFactory", false, ManyCore_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.ISolver", false, ManyCore_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.DimacsOutputSolver", false, ManyCore_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.DimacsStringSolver", false, ManyCore_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.LexicoDecorator", false, ManyCore_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ManyCore_ESTest_scaffolding.class.getClassLoader()); 
