...
public class Minimal4CardinalityModel_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.tools.Minimal4CardinalityModel"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Minimal4CardinalityModel_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sat4j.minisat.core.ILits", false, Minimal4CardinalityModel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.ISolver", false, Minimal4CardinalityModel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.IVecInt", false, Minimal4CardinalityModel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.VarMapper", false, Minimal4CardinalityModel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.SolutionFoundListener", false, Minimal4CardinalityModel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.StatisticsSolver", false, Minimal4CardinalityModel_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Minimal4CardinalityModel_ESTest_scaffolding.class.getClassLoader()); 
