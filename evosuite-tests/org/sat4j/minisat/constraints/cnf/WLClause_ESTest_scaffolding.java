...
public class WLClause_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.minisat.constraints.cnf.WLClause"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(WLClause_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.PrintWriter", false, WLClause_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Comparator", false, WLClause_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.constraints.CardinalityDataStructureYanMax", false, WLClause_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.ILits", false, WLClause_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.IOrder", false, WLClause_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.LearningStrategy", false, WLClause_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.RestartStrategy", false, WLClause_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.SearchParams", false, WLClause_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.IVecInt", false, WLClause_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.SolutionCounter", false, WLClause_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(WLClause_ESTest_scaffolding.class.getClassLoader()); 
