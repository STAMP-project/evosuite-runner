...
public class Clauses_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.minisat.constraints.cnf.Clauses"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Clauses_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sat4j.core.ASolverFactory", false, Clauses_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.ISolver", false, Clauses_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Clauses_ESTest_scaffolding.class.getClassLoader()); 
