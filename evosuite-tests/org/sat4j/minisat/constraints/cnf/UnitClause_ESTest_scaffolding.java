...
public class UnitClause_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.minisat.constraints.cnf.UnitClause"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(UnitClause_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sat4j.core.ASolverFactory", false, UnitClause_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.constraints.CardinalityDataStructure", false, UnitClause_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.SubModelIterator", false, UnitClause_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(UnitClause_ESTest_scaffolding.class.getClassLoader()); 
