...
public class MinWatchCard_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.minisat.constraints.card.MinWatchCard"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MinWatchCard_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sat4j.minisat.core.ILits", false, MinWatchCard_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.IPhaseSelectionStrategy", false, MinWatchCard_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.SearchParams", false, MinWatchCard_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.SolverStats", false, MinWatchCard_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.IVecInt", false, MinWatchCard_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.MandatoryLiteralListener", false, MinWatchCard_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.UnitPropagationListener", false, MinWatchCard_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MinWatchCard_ESTest_scaffolding.class.getClassLoader()); 
