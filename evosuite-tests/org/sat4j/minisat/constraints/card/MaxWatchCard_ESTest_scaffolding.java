...
public class MaxWatchCard_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.minisat.constraints.card.MaxWatchCard"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MaxWatchCard_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sat4j.minisat.core.ILits", false, MaxWatchCard_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.IVecInt", false, MaxWatchCard_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MaxWatchCard_ESTest_scaffolding.class.getClassLoader()); 
