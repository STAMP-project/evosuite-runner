...
public class SizeLCDS_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.minisat.core.SizeLCDS"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SizeLCDS_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sat4j.core.ASolverFactory", false, SizeLCDS_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.ILits", false, SizeLCDS_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.LearningStrategy", false, SizeLCDS_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.Solver", false, SizeLCDS_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.orders.VarOrderHeap", false, SizeLCDS_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SizeLCDS_ESTest_scaffolding.class.getClassLoader()); 
