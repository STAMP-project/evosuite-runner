...
public class ActivityLCDS_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.minisat.core.ActivityLCDS"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ActivityLCDS_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sat4j.minisat.core.ILits", false, ActivityLCDS_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.Solver", false, ActivityLCDS_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.orders.VarOrderHeap", false, ActivityLCDS_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.specs.Constr", false, ActivityLCDS_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ActivityLCDS_ESTest_scaffolding.class.getClassLoader()); 
