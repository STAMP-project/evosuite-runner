...
public class WatcherBasedPrimeImplicantStrategy_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.minisat.core.WatcherBasedPrimeImplicantStrategy"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(WatcherBasedPrimeImplicantStrategy_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Comparator", false, WatcherBasedPrimeImplicantStrategy_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.minisat.core.Solver", false, WatcherBasedPrimeImplicantStrategy_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(WatcherBasedPrimeImplicantStrategy_ESTest_scaffolding.class.getClassLoader()); 
