...
public class AbstractSelectorVariablesDecorator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.opt.AbstractSelectorVariablesDecorator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AbstractSelectorVariablesDecorator_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sat4j.tools.DimacsOutputSolver", false, AbstractSelectorVariablesDecorator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.Minimal4InclusionModel", false, AbstractSelectorVariablesDecorator_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AbstractSelectorVariablesDecorator_ESTest_scaffolding.class.getClassLoader()); 
