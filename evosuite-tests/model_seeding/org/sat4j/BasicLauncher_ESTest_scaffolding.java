...
public class BasicLauncher_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.sat4j.BasicLauncher"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BasicLauncher_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sat4j.core.ASolverFactory", false, BasicLauncher_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sat4j.tools.ManyCore", false, BasicLauncher_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BasicLauncher_ESTest_scaffolding.class.getClassLoader()); 
