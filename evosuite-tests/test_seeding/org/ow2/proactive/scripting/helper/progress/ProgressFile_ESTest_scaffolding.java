...
public class ProgressFile_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.File", false, ProgressFile_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.nio.file.FileSystem", false, ProgressFile_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.nio.file.Path", false, ProgressFile_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.nio.file.spi.FileSystemProvider", false, ProgressFile_ESTest_scaffolding.class.getClassLoader()));
  }
