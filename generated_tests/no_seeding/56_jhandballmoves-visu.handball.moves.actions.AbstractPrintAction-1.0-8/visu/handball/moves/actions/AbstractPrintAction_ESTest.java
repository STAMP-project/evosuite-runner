...
public class AbstractPrintAction_ESTest extends AbstractPrintAction_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
          ...
          ActionEvent actionEvent0 = new ActionEvent(defaultTableCellRenderer_UIResource0, 0, "iuN+|");
  ...
  public void test1()  throws Throwable  {
      ...
      AbstractPrintAction.SequencePagePrintable abstractPrintAction_SequencePagePrintable0 = printMoveAction0.new SequencePagePrintable(20);
      DebugGraphics debugGraphics0 = new DebugGraphics();
      PageFormat pageFormat0 = new PageFormat();
      // Undeclared exception!
      try { 
        abstractPrintAction_SequencePagePrintable0.print(debugGraphics0, pageFormat0, 20);
