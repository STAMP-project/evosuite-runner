...
public class bcFileDialog_ESTest extends bcFileDialog_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "0,M`MEgQ+&o@}<1$U");
      bcFileDialog bcFileDialog0 = null;
      try {
        bcFileDialog0 = new bcFileDialog("0,M`MEgQ+&o@}<1$U", "0,M`MEgQ+&o@}<1$U");
  ...
  public void test2()  throws Throwable  {
      bcFileDialog bcFileDialog0 = null;
      try {
        bcFileDialog0 = new bcFileDialog("U");
        fail("Expecting exception: HeadlessException");
