...
public class StandardEnumerator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "de.paragon.explorer.util.StandardEnumerator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(StandardEnumerator_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "de.paragon.explorer.figure.InformationFigure",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("de.paragon.explorer.figure.InformationFigure", false, StandardEnumerator_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(StandardEnumerator_ESTest_scaffolding.class.getClassLoader()); 
