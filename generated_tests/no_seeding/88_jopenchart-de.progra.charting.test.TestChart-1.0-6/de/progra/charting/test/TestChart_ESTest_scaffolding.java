...
public class TestChart_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "de.progra.charting.test.TestChart"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TestChart_ESTest_scaffolding.class.getClassLoader() ,
      "de.progra.charting.render.LineChartRenderer",
      "de.progra.charting.ChartEncoder",
      ...
      "de.progra.charting.test.TestChart",
      ...
      "de.progra.charting.model.FunctionPlotter",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TestChart_ESTest_scaffolding.class.getClassLoader()); 
