...
public class AbstractPrintAction_ESTest extends AbstractPrintAction_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      HandballModel handballModel0 = new HandballModel();
      PrintMoveAction printMoveAction0 = new PrintMoveAction(handballModel0);
      AbstractPrintAction.SequencePagePrintable abstractPrintAction_SequencePagePrintable0 = printMoveAction0.new SequencePagePrintable((-2583));
      DebugGraphics debugGraphics0 = new DebugGraphics();
      PageFormat pageFormat0 = new PageFormat();
      // Undeclared exception!
      try { 
        abstractPrintAction_SequencePagePrintable0.print(debugGraphics0, pageFormat0, (-2583));
