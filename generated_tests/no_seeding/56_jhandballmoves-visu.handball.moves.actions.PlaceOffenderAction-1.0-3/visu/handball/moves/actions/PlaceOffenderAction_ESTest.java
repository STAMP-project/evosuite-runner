...
public class PlaceOffenderAction_ESTest extends PlaceOffenderAction_ESTest_scaffolding {
  ...
  public void test3()  throws Throwable  {
      ...
      handballModel0.setState(handballModel_State0);
      ActionEvent actionEvent0 = new ActionEvent(";V)X6+XCX", (-1), ";V)X6+XCX", 0L, 0);
      MetalComboBoxUI metalComboBoxUI0 = new MetalComboBoxUI();
      PropertyChangeListener propertyChangeListener0 = metalComboBoxUI0.createPropertyChangeListener();
      placeOffenderAction0.addPropertyChangeListener(propertyChangeListener0);
      ...
      try { 
        ...
        fail("Expecting exception: ClassCastException");
         ...
         //
         // visu.handball.moves.actions.PlaceOffenderAction cannot be cast to javax.swing.JComboBox
         //
  ...
  public void test4()  throws Throwable  {
      HandballModel handballModel0 = new HandballModel();
      PlaceOffenderAction placeOffenderAction0 = new PlaceOffenderAction(handballModel0);
      ActionEvent actionEvent0 = new ActionEvent(";V)X6+XCX", (-765), ";V)X6+XCX", 0L, (-1));
      placeOffenderAction0.actionPerformed(actionEvent0);
