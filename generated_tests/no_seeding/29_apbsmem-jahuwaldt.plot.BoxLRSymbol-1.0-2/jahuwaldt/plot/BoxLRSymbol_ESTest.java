...
public class BoxLRSymbol_ESTest extends BoxLRSymbol_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      boxLRSymbol0.generatePoints((-403), (-403));
  ...
  public void test1()  throws Throwable  {
      BoxLRSymbol boxLRSymbol0 = new BoxLRSymbol();
      boxLRSymbol0.generatePoints((-2473), (-2473));
      int[] intArray0 = new int[4];
      boxLRSymbol0.xPoints = intArray0;
      // Undeclared exception!
      try { 
        boxLRSymbol0.generatePoints(0, 353);
  ...
  public void test2()  throws Throwable  {
      BoxLRSymbol boxLRSymbol0 = new BoxLRSymbol();
      boxLRSymbol0.generatePoints((-558), (-2478));
      boxLRSymbol0.generatePoints((-2858), (-2858));
