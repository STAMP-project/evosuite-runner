...
public class StopAnimationAction_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "visu.handball.moves.actions.StopAnimationAction"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(StopAnimationAction_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "visu.handball.moves.actions.StopAnimationAction",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("visu.handball.moves.model.HandballModel", false, StopAnimationAction_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(StopAnimationAction_ESTest_scaffolding.class.getClassLoader()); 
