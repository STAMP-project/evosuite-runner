...
public class AllStatistics_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "de.outstare.fortbattleplayer.statistics.AllStatistics"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AllStatistics_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "de.outstare.fortbattleplayer.statistics.CombatantStatType",
      "de.outstare.fortbattleplayer.statistics.CombatantStatistic",
      ...
      "de.outstare.fortbattleplayer.statistics.DataAggregationType",
      "de.outstare.fortbattleplayer.model.CombatantState",
      "de.outstare.fortbattleplayer.model.impl.SimpleCombatant",
      "de.outstare.fortbattleplayer.statistics.AllStatistics",
      ...
      "de.outstare.fortbattleplayer.statistics.DataAggregationType$3",
      "de.outstare.fortbattleplayer.model.SectorBonus",
      "de.outstare.fortbattleplayer.statistics.DataAggregationType$4",
      "de.outstare.fortbattleplayer.statistics.DataAggregationType$5",
      "de.outstare.fortbattleplayer.model.impl.SimpleWeapon",
      "de.outstare.fortbattleplayer.statistics.DataAggregationType$6",
      "de.outstare.fortbattleplayer.statistics.DataAggregationType$1",
      "de.outstare.fortbattleplayer.statistics.RoundStatGenerator",
      "de.outstare.fortbattleplayer.statistics.DataAggregationType$2",
      "de.outstare.fortbattleplayer.statistics.DataSet",
      ...
      "de.outstare.fortbattleplayer.statistics.StaticStatistics"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AllStatistics_ESTest_scaffolding.class.getClassLoader()); 
