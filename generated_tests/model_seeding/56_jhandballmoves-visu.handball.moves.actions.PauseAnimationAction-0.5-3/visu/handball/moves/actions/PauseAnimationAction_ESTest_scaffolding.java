...
public class PauseAnimationAction_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "visu.handball.moves.actions.PauseAnimationAction"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PauseAnimationAction_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "visu.handball.moves.actions.PauseAnimationAction",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("visu.handball.moves.model.HandballModel", false, PauseAnimationAction_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PauseAnimationAction_ESTest_scaffolding.class.getClassLoader()); 
