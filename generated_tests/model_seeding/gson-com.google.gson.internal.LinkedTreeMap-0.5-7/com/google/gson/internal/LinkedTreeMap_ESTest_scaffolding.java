...
public class LinkedTreeMap_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("java.util.Map$Entry", false, LinkedTreeMap_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiConsumer", false, LinkedTreeMap_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, LinkedTreeMap_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToIntFunction", false, LinkedTreeMap_ESTest_scaffolding.class.getClassLoader()));
  }
