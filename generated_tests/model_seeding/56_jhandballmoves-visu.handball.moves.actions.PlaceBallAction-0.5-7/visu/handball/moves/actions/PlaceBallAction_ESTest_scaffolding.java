...
public class PlaceBallAction_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "visu.handball.moves.actions.PlaceBallAction"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PlaceBallAction_ESTest_scaffolding.class.getClassLoader() ,
      "visu.handball.moves.model.player.Ball",
      "visu.handball.moves.resources.Resources",
      "visu.handball.moves.views.BallDrawer",
      "visu.handball.moves.actions.PlaceBallAction",
      ...
      "visu.handball.moves.actions.PlaceBallAction$1",
      "visu.handball.moves.actions.SaveAction",
      "visu.handball.moves.model.HandballModel$State"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("visu.handball.moves.model.HandballModel", false, PlaceBallAction_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("visu.handball.moves.model.player.Player", false, PlaceBallAction_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PlaceBallAction_ESTest_scaffolding.class.getClassLoader()); 
