...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      Boolean boolean0 = Boolean.valueOf("TRM-");
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(boolean0);
      assertFalse(jsonWriter0.isLenient());
  }
  ...
  public void test12()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-1072L));
  ...
  public void test16()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(1968.105157);
  ...
  public void test28()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonTreeWriter0.name(";bH5}");
  ...
  public void test41()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      Short short0 = Short.valueOf((short)992);
      jsonTreeWriter0.setLenient(true);
  ...
  public void test42()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.value((Number) 34L);
      JsonElement jsonElement0 = jsonTreeWriter0.get();
  ...
  public void test54()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("eHmRP^<bI*fTf-JQ");
      jsonTreeWriter0.value(598.391705964678);
      jsonTreeWriter0.name("eHmRP^<bI*fTf-JQ");
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonTreeWriter0.name("eHmRP^<bI*fTf-JQ");
  ...
  public void test55()  throws Throwable  {
      ...
      jsonTreeWriter0.name("eHmRP^<bI*fTf-JQ");
      jsonTreeWriter0.value(598.391705964678);
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("eHmRP^<bI*fTf-JQ");
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("eHmRP^<bI*fTf-JQ");
  ...
  public void test58()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.jsonValue("QpNK7\"F^2");
