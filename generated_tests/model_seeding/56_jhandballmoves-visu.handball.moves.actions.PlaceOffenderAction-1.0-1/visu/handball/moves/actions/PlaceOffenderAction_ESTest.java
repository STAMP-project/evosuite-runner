...
public class PlaceOffenderAction_ESTest extends PlaceOffenderAction_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((-2483)).when(moveEvent0).compareTo(any(visu.handball.moves.model.MoveEvent.class));
      doReturn(0, 0).when(moveEvent0).getDestinationX();
      doReturn(0, 0).when(moveEvent0).getDestinationY();
      doReturn((Player) null).when(moveEvent0).getPlayer();
      doReturn((-2483)).when(moveEvent0).getSequenceNr();
      handballModel0.addMoveEvent(moveEvent0);
      PlaceOffenderAction placeOffenderAction0 = new PlaceOffenderAction(handballModel0);
      ActionEvent actionEvent0 = new ActionEvent(placeOffenderAction0, 0, "", 0, 2509);
  ...
  public void test5()  throws Throwable  {
      HandballModel handballModel0 = new HandballModel();
      PlaceOffenderAction placeOffenderAction0 = new PlaceOffenderAction(handballModel0);
      ActionEvent actionEvent0 = new ActionEvent(handballModel0, (-1804), "ShortDescription", (-1804), (-1804));
      placeOffenderAction0.actionPerformed(actionEvent0);
      assertEquals((-1804), actionEvent0.getModifiers());
  }
}
