...
public class LineChartRenderer_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "de.progra.charting.render.LineChartRenderer"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LineChartRenderer_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("de.progra.charting.CoordSystem", false, LineChartRenderer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("de.progra.charting.model.ChartDataModel", false, LineChartRenderer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.Graphics2D", false, LineChartRenderer_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LineChartRenderer_ESTest_scaffolding.class.getClassLoader()); 
