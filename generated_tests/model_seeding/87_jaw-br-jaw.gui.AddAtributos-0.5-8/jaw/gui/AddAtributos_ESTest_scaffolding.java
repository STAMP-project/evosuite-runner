...
public class AddAtributos_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "jaw.gui.AddAtributos"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AddAtributos_ESTest_scaffolding.class.getClassLoader() ,
      "jaw.gui.AddAtributos",
      ...
      "jaw.util.Conversor",
      "jaw.gui.AddAtributos$2",
      "jaw.gui.ProcessarEntidadesTree$1",
      "jaw.gui.AddAtributos$1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AddAtributos_ESTest_scaffolding.class.getClassLoader()); 
