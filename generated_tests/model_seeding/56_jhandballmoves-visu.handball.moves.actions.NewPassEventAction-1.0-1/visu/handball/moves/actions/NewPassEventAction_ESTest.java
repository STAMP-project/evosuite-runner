...
public class NewPassEventAction_ESTest extends NewPassEventAction_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      HandballModel handballModel0 = new HandballModel();
      Defender defender0 = new Defender((-1232), (-1232));
      MoveEvent moveEvent0 = new MoveEvent(defender0, 1, (-1232));
      defender0.setHasBall(true);
      moveEvent0.setDestinationPoint(1, 1, false);
      handballModel0.setActualMoveEvent(moveEvent0);
      NewPassEventAction newPassEventAction0 = new NewPassEventAction(handballModel0);
      ActionEvent actionEvent0 = new ActionEvent(moveEvent0, (-1232), "@-b#{{e");
  ...
  public void test4()  throws Throwable  {
      HandballModel handballModel0 = new HandballModel();
      Defender defender0 = new Defender(1532, 21);
      MoveEvent moveEvent0 = new MoveEvent(defender0, 1532, 1526);
      moveEvent0.setDestinationPoint(1526, (-3177), false);
      handballModel0.setActualMoveEvent(moveEvent0);
  ...
  public void test6()  throws Throwable  {
      HandballModel handballModel0 = new HandballModel();
      Defender defender0 = new Defender((-1780), (-1780));
