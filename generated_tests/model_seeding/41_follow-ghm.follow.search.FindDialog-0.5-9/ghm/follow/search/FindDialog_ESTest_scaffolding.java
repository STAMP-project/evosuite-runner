...
public class FindDialog_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FindDialog_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "ghm.follow.font.InvalidFontSizeException",
      "ghm.follow.config.Configure$CfgFontSelectionPanel",
      "ghm.follow.font.InvalidFontException",
      "ghm.follow.gui.ClearAll",
      "ghm.follow.font.NoFontStyleSelectedException",
      ...
      "ghm.follow.font.FontSelectionPanel$PhraseCanvas",
      ...
      "ghm.follow.font.NoFontSizeSpecifiedException",
      "ghm.follow.gui.Clear",
      "ghm.follow.gui.PopupMenu",
      "ghm.follow.gui.Pause",
      "ghm.follow.font.FontSelectionPanel$FontStyleList",
      "ghm.follow.io.OutputDestination",
      "ghm.follow.gui.Reset",
      "ghm.follow.font.NoFontFamilySelectedException",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("ghm.follow.FollowApp", false, FindDialog_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("ghm.follow.search.Find", false, FindDialog_ESTest_scaffolding.class.getClassLoader()));
  }
