...
public class TabLSymbol_ESTest extends TabLSymbol_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try { 
        tabLSymbol0.generatePoints(0, (-2940));
  ...
  public void test1()  throws Throwable  {
      TabLSymbol tabLSymbol0 = new TabLSymbol();
      tabLSymbol0.generatePoints(0, (-1805));
      int[] intArray0 = new int[3];
      tabLSymbol0.yPoints = intArray0;
      // Undeclared exception!
      try { 
        tabLSymbol0.generatePoints(1048, 0);
  ...
  public void test2()  throws Throwable  {
      TabLSymbol tabLSymbol0 = new TabLSymbol();
      tabLSymbol0.generatePoints(0, 1909);
      tabLSymbol0.generatePoints(1, 1909);
