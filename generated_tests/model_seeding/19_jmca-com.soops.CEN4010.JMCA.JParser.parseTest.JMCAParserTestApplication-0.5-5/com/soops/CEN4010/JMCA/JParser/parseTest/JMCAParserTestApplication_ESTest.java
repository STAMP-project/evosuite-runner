...
public class JMCAParserTestApplication_ESTest extends JMCAParserTestApplication_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Expression");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "%17xj^V|");
      JMCAParserTestApplication jMCAParserTestApplication0 = null;
      try {
        jMCAParserTestApplication0 = new JMCAParserTestApplication("Expression");
  ...
  public void test4()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("S{WD`a#]./IO,gCD");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      JMCAParserTestApplication jMCAParserTestApplication0 = null;
      try {
        jMCAParserTestApplication0 = new JMCAParserTestApplication("S{WD`a#]./IO,gCD");
