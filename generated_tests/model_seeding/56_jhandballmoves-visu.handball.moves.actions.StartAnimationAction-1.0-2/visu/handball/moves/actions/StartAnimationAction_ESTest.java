...
public class StartAnimationAction_ESTest extends StartAnimationAction_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      Offender offender0 = new Offender(681, 681);
      ...
      doReturn(0, 681, (-500), (-500)).when(moveEvent0).getSequenceNr();
      ...
      ActionEvent actionEvent0 = new ActionEvent(startAnimationAction0, 0, "3W", 0);
  ...
  public void test5()  throws Throwable  {
      ...
      Offender offender0 = new Offender(681, 681);
      MoveEvent moveEvent0 = mock(MoveEvent.class, new ViolatedAssumptionAnswer());
      doReturn(offender0, (Player) null, (Player) null).when(moveEvent0).getPlayer();
      doReturn(0, 681, (-500), (-500), 0).when(moveEvent0).getSequenceNr();
