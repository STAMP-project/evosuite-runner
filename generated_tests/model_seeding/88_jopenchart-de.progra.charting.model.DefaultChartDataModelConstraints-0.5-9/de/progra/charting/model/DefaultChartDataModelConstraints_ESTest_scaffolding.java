...
public class DefaultChartDataModelConstraints_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "de.progra.charting.model.DefaultChartDataModelConstraints"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DefaultChartDataModelConstraints_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("de.progra.charting.model.AbstractChartDataModel", false, DefaultChartDataModelConstraints_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Comparator", false, DefaultChartDataModelConstraints_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DefaultChartDataModelConstraints_ESTest_scaffolding.class.getClassLoader()); 
