...
public class LocalFileBrowser_ESTest extends LocalFileBrowser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        localFileBrowser0.rename((FileListItem) null, "{8?\"+1+");
  ...
  public void test08()  throws Throwable  {
      FileDisplay fileDisplay0 = mock(FileDisplay.class, new ViolatedAssumptionAnswer());
      LocalFileBrowser localFileBrowser0 = new LocalFileBrowser(fileDisplay0, (SSHPropertyHandler) null);
      FileListItem[] fileListItemArray0 = new FileListItem[3];
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      ...
      FileListItem fileListItem0 = new FileListItem(",.", ",.", true, 1L, 1L);
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      FileDisplay fileDisplay0 = mock(FileDisplay.class, new ViolatedAssumptionAnswer());
      LocalFileBrowser localFileBrowser0 = new LocalFileBrowser(fileDisplay0, sSHPropertyHandler0);
      FileListItem fileListItem0 = new FileListItem(",.", ",.", true, (-3287L), (-3287L));
      try { 
        localFileBrowser0.fileDoubleClicked(fileListItem0);
        fail("Expecting exception: Exception");
  ...
  public void test17()  throws Throwable  {
      ...
      LocalFileBrowser localFileBrowser0 = new LocalFileBrowser(fileDisplay0, sSHPropertyHandler0);
      try { 
        localFileBrowser0.changeDirectory("OkWk|APs");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Directory OkWk|APs does not exist or you do not have permission to access it.
         //
         verifyException("com.isnetworks.ssh.LocalFileBrowser", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      FileDisplay fileDisplay0 = mock(FileDisplay.class, new ViolatedAssumptionAnswer());
      LocalFileBrowser localFileBrowser0 = new LocalFileBrowser(fileDisplay0, sSHPropertyHandler0);
      localFileBrowser0.makeDirectory("Can't get path :");
  }
  ...
  public void test25()  throws Throwable  {
      ...
      FileDisplay fileDisplay0 = mock(FileDisplay.class, new ViolatedAssumptionAnswer());
      LocalFileBrowser localFileBrowser0 = new LocalFileBrowser(fileDisplay0, sSHPropertyHandler0);
      localFileBrowser0.putFiles((SSHSCPIndicator) null, (FileDisplay) null, (FileDisplay) null, true);
  }
