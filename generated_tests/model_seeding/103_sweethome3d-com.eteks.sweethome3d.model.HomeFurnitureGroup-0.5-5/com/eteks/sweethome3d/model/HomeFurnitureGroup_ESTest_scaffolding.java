...
public class HomeFurnitureGroup_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.eteks.sweethome3d.model.HomeFurnitureGroup"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(HomeFurnitureGroup_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.eteks.sweethome3d.model.HomePieceOfFurniture", false, HomeFurnitureGroup_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.beans.PropertyChangeListener", false, HomeFurnitureGroup_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.net.URLStreamHandler", false, HomeFurnitureGroup_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(HomeFurnitureGroup_ESTest_scaffolding.class.getClassLoader()); 
