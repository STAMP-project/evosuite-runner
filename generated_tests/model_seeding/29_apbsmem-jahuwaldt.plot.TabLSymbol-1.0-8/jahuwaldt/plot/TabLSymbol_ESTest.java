...
public class TabLSymbol_ESTest extends TabLSymbol_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try { 
        tabLSymbol0.generatePoints((-3000), (-1955));
  ...
  public void test1()  throws Throwable  {
      TabLSymbol tabLSymbol0 = new TabLSymbol();
      tabLSymbol0.generatePoints((-3068), (-3068));
      int[] intArray0 = new int[3];
      tabLSymbol0.xPoints = intArray0;
      // Undeclared exception!
      try { 
        tabLSymbol0.generatePoints((-3068), 3);
  ...
  public void test2()  throws Throwable  {
      TabLSymbol tabLSymbol0 = new TabLSymbol();
      tabLSymbol0.generatePoints(71, 71);
      tabLSymbol0.generatePoints(2100, 0);
