...
public class HomePieceOfFurniture_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.eteks.sweethome3d.model.Level", false, HomePieceOfFurniture_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.eteks.sweethome3d.model.Light", false, HomePieceOfFurniture_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.eteks.sweethome3d.model.Sash", false, HomePieceOfFurniture_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.beans.PropertyChangeListener", false, HomePieceOfFurniture_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.net.URLStreamHandler", false, HomePieceOfFurniture_ESTest_scaffolding.class.getClassLoader()));
  }
