...
public class AbstractSupportSaveAction_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "visu.handball.moves.actions.AbstractSupportSaveAction"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AbstractSupportSaveAction_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "visu.handball.moves.actions.OpenAction",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("visu.handball.moves.model.HandballModel", false, AbstractSupportSaveAction_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AbstractSupportSaveAction_ESTest_scaffolding.class.getClassLoader()); 
