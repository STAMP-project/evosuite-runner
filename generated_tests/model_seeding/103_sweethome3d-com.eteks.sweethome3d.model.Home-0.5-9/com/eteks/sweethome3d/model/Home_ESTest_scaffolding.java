...
public class Home_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.eteks.sweethome3d.model.Home"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.eteks.sweethome3d.model.CollectionListener", false, Home_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.eteks.sweethome3d.model.Compass", false, Home_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.eteks.sweethome3d.model.HomePieceOfFurniture", false, Home_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.eteks.sweethome3d.model.Label", false, Home_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.eteks.sweethome3d.model.Sash", false, Home_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.eteks.sweethome3d.model.SelectionListener", false, Home_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.beans.PropertyChangeEvent", false, Home_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.beans.PropertyChangeListener", false, Home_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.net.URLStreamHandler", false, Home_ESTest_scaffolding.class.getClassLoader()));
  }
