...
public class XLoader_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "module.XLoader"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(XLoader_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "util.ManagedObject",
      "module.Message",
      "module.XLoader$SnoopyModule"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(XLoader_ESTest_scaffolding.class.getClassLoader()); 
