...
public class Gson_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("java.io.File", false, Gson_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.Reader", false, Gson_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.Writer", false, Gson_ESTest_scaffolding.class.getClassLoader()));
