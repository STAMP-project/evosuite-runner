...
public class AbstractPrintAction_ESTest extends AbstractPrintAction_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
          ...
          ActionEvent actionEvent0 = new ActionEvent(handballModel0, 0, "visu.handball.moves.actions.AbstractPrintAction", 0, 0);
  ...
  public void test1()  throws Throwable  {
      HandballModel handballModel0 = new HandballModel();
      PrintMoveAction printMoveAction0 = new PrintMoveAction(handballModel0);
      AbstractPrintAction.SequencePagePrintable abstractPrintAction_SequencePagePrintable0 = printMoveAction0.new SequencePagePrintable((-2681));
      PageFormat pageFormat0 = new PageFormat();
      // Undeclared exception!
      try { 
        abstractPrintAction_SequencePagePrintable0.print((Graphics) null, pageFormat0, (-2681));
