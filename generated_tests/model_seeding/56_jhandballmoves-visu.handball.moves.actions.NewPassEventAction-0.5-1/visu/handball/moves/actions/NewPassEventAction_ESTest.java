...
public class NewPassEventAction_ESTest extends NewPassEventAction_ESTest_scaffolding {
  ...
  public void test3()  throws Throwable  {
      HandballModel handballModel0 = new HandballModel();
      Offender offender0 = new Offender((-1494), (-1494));
      ...
      doReturn((-170), (-170), (-4784)).when(moveEvent0).getSequenceNr();
  ...
  public void test4()  throws Throwable  {
      ...
      MoveEvent moveEvent0 = mock(MoveEvent.class, new ViolatedAssumptionAnswer());
      doReturn(offender0).when(moveEvent0).getPlayer();
      doReturn((-170), (-170), (-2235)).when(moveEvent0).getSequenceNr();
      doReturn(true).when(moveEvent0).isDestinationPointSet();
      ...
      doReturn(0, 0, 0, 0).when(moveEvent1).getSequenceNr();
  ...
  public void test5()  throws Throwable  {
      HandballModel handballModel0 = new HandballModel();
      Offender offender0 = new Offender((-170), (-170));
      MoveEvent moveEvent0 = mock(MoveEvent.class, new ViolatedAssumptionAnswer());
      doReturn(offender0).when(moveEvent0).getPlayer();
      doReturn((-170), (-170)).when(moveEvent0).getSequenceNr();
      doReturn(true).when(moveEvent0).isDestinationPointSet();
      handballModel0.setActualMoveEvent(moveEvent0);
      NewPassEventAction newPassEventAction0 = new NewPassEventAction(handballModel0);
      newPassEventAction0.modelChanged();
  ...
  public void test6()  throws Throwable  {
      ...
      doReturn((-264)).when(moveEvent0).getSequenceNr();
      doReturn(true).when(moveEvent0).isDestinationPointSet();
      handballModel0.setActualMoveEvent(moveEvent0);
      NewPassEventAction newPassEventAction0 = new NewPassEventAction(handballModel0);
      newPassEventAction0.modelChanged();
  ...
  public void test8()  throws Throwable  {
      ...
      NewPassEventAction newPassEventAction0 = new NewPassEventAction(handballModel0);
      newPassEventAction0.actionPerformed(actionEvent0);
      assertEquals((-170), handballModel0.getAcutalSequenceNr());
  ...
  public void test9()  throws Throwable  {
      HandballModel handballModel0 = new HandballModel();
      NewPassEventAction newPassEventAction0 = new NewPassEventAction(handballModel0);
      ActionEvent actionEvent0 = new ActionEvent(newPassEventAction0, 500, "&PO1Je>H&a$M2n;^@S1");
      newPassEventAction0.actionPerformed(actionEvent0);
      assertEquals(500, actionEvent0.getID());
  }
}
