...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter0.name("T=YI,6Avb`a5`cC%C");
      // Undeclared exception!
      try { 
        jsonWriter0.value(3616.485);
  ...
  public void test01()  throws Throwable  {
      ...
      jsonWriter0.value(".^t*\u0005\"+h");
      assertEquals("\".^t*\\u0005\\\"+h\"", stringWriter0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(writer0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.value((-888L));
      assertTrue(jsonWriter1.getSerializeNulls());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      jsonWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter2 = jsonWriter1.name("T=YI,6Avb`a5`cC%C");
      JsonWriter jsonWriter3 = jsonWriter2.value(1127.3917187971686);
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(writer0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("u/so\"t:_");
      assertTrue(jsonWriter1.getSerializeNulls());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("+2oZ8D");
      assertEquals("+2oZ8D", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test36()  throws Throwable  {
      Writer writer0 = mock(Writer.class, new ViolatedAssumptionAnswer());
      JsonWriter jsonWriter0 = new JsonWriter(writer0);
      JsonWriter jsonWriter1 = jsonWriter0.value("jq!Q5rNF8]\"");
      // Undeclared exception!
      try { 
        jsonWriter1.value("jq!Q5rNF8]\"");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("u5oDI8ns~LjTI[_@7%");
      jsonWriter0.value("u5oDI8ns~LjTI[_@7%");
      // Undeclared exception!
      try { 
  ...
  public void test48()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter0.value("u5oDI8ns~LjTI[_@7%");
      jsonWriter2.name("u5oDI8ns~LjTI[_@7%");
      jsonWriter1.beginObject();
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test49()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("]oQ^:qZ");
      jsonWriter0.beginArray();
      jsonWriter0.value(".^t*\u0005\"+h");
      assertEquals("[\n]oQ^:qZ\".^t*\\u0005\\\"+h\"", stringWriter0.toString());
  }
