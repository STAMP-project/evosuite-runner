...
public class PrintActualSequenzAction_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "visu.handball.moves.actions.PrintActualSequenzAction"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PrintActualSequenzAction_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.print.Book", false, PrintActualSequenzAction_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.print.PageFormat", false, PrintActualSequenzAction_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PrintActualSequenzAction_ESTest_scaffolding.class.getClassLoader()); 
