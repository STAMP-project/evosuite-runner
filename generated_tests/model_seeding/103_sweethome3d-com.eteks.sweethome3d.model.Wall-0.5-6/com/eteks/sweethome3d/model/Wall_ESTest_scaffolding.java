...
public class Wall_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.eteks.sweethome3d.model.Wall"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Wall_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.eteks.sweethome3d.model.TextureImage", false, Wall_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.beans.PropertyChangeEvent", false, Wall_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.beans.PropertyChangeListener", false, Wall_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.net.URLStreamHandler", false, Wall_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Function", false, Wall_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Wall_ESTest_scaffolding.class.getClassLoader()); 
