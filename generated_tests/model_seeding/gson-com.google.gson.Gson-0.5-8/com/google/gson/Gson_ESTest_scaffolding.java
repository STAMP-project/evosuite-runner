...
public class Gson_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.google.gson.JsonElement", false, Gson_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.TypeAdapterFactory", false, Gson_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.reflect.TypeToken", false, Gson_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.stream.JsonWriter", false, Gson_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.Reader", false, Gson_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.LongBinaryOperator", false, Gson_ESTest_scaffolding.class.getClassLoader()));
  }
