...
public class NewMoveEventAction_ESTest extends NewMoveEventAction_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MoveEvent moveEvent0 = new MoveEvent(player0, (-346));
      handballModel0.setActualMoveEvent(moveEvent0);
      TableHandballModel tableHandballModel0 = new TableHandballModel(handballModel0);
      ActionEvent actionEvent0 = new ActionEvent(tableHandballModel0, 5, "<GMqa[MKvb", 0);
  ...
  public void test2()  throws Throwable  {
      HandballModel handballModel0 = new HandballModel();
      Defender defender0 = new Defender((-4), (-4));
      ...
      ActionEvent actionEvent0 = new ActionEvent(newMoveEventAction0, 1, "Mke-C", (-1300L), (-346));
      // Undeclared exception!
      try { 
        newMoveEventAction0.actionPerformed(actionEvent0);
        fail("Expecting exception: ClassCastException");
  ...
  public void test4()  throws Throwable  {
      ...
      assertFalse(moveEvent1.isDestinationPointSet());
  }
  ...
  public void test6()  throws Throwable  {
      ...
      MoveEvent moveEvent0 = mock(MoveEvent.class, new ViolatedAssumptionAnswer());
      doReturn(defender0).when(moveEvent0).getPlayer();
      doReturn(7, 7, 7).when(moveEvent0).getSequenceNr();
      doReturn(true).when(moveEvent0).isDestinationPointSet();
      handballModel0.setActualMoveEvent(moveEvent0);
      NewMoveEventAction newMoveEventAction0 = new NewMoveEventAction(handballModel0);
      newMoveEventAction0.modelChanged();
  ...
  public void test7()  throws Throwable  {
      ...
      MoveEvent moveEvent0 = mock(MoveEvent.class, new ViolatedAssumptionAnswer());
      doReturn(defender0).when(moveEvent0).getPlayer();
      doReturn(7, 7).when(moveEvent0).getSequenceNr();
      doReturn(true).when(moveEvent0).isDestinationPointSet();
      handballModel0.setActualMoveEvent(moveEvent0);
  ...
  public void test8()  throws Throwable  {
      ...
      handballModel0.setActualMoveEvent(moveEvent0);
      NewMoveEventAction newMoveEventAction0 = new NewMoveEventAction(handballModel0);
      ActionEvent actionEvent0 = new ActionEvent(defender0, 0, "`JHy_Y>egDc}dwUF", 1, 7);
      newMoveEventAction0.actionPerformed(actionEvent0);
  ...
  public void test9()  throws Throwable  {
      HandballModel handballModel0 = new HandballModel();
      NewMoveEventAction newMoveEventAction0 = new NewMoveEventAction(handballModel0);
      ActionEvent actionEvent0 = new ActionEvent(handballModel0, 7, ".Q<sXo(_");
      newMoveEventAction0.actionPerformed(actionEvent0);
