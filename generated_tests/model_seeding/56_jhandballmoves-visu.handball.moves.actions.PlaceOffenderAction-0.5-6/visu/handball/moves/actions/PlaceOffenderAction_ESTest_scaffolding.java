...
public class PlaceOffenderAction_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "visu.handball.moves.actions.PlaceOffenderAction"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PlaceOffenderAction_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "visu.handball.moves.actions.PlaceOffenderAction",
      ...
      "visu.handball.moves.actions.PlaceOffenderAction$1",
      "visu.handball.moves.actions.SaveAction",
      "visu.handball.moves.model.HandballModel$State"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("visu.handball.moves.model.HandballModel", false, PlaceOffenderAction_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("visu.handball.moves.model.MoveEvent", false, PlaceOffenderAction_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PlaceOffenderAction_ESTest_scaffolding.class.getClassLoader()); 
